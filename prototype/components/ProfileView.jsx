  ...
  return (
    <div style={profStyles.root}>
      ...
      <div style={profStyles.content}>
        {tab === 'overview' && (
          <div style={profStyles.overviewGrid}>
            ...
            <div style={profStyles.card}>
              ...
              {[
                { label: 'Publication score', val: 68, max: 100, color: 'oklch(0.42 0.14 260)' },
        ...
        {tab === 'contributions' && (
          <div style={profStyles.tableWrap}>
            <div style={{ fontSize: 17, color: 'oklch(0.35 0.01 80)', lineHeight: 1.7, marginBottom: 20, fontFamily: 'var(--font-ui)', maxWidth: 580 }}>
...
const profStyles = {
  ...
  profileBanner: { background: '#fff', borderBottom: '1px solid oklch(0.92 0.008 80)', padding: '24px 28px', display: 'flex', alignItems: 'center', gap: 20 },
  avatarLarge: { width: 52, height: 52, borderRadius: '50%', background: 'oklch(0.42 0.14 260)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 30, fontWeight: 700, flexShrink: 0, fontFamily: 'var(--font-ui)' },
  profileInfo: { flex: 1 },
  name: { fontSize: 30, fontWeight: 700, color: 'oklch(0.13 0.015 80)', fontFamily: 'var(--font-display)', letterSpacing: '-0.02em', marginBottom: 3 },
  role: { fontSize: 16, color: 'oklch(0.5 0.01 80)', fontFamily: 'var(--font-ui)', marginBottom: 6 },
  tagRow: { display: 'flex', gap: 5 },
  fieldTag: { fontSize: 16, background: 'oklch(0.94 0.015 80)', color: 'oklch(0.4 0.02 80)', padding: '3px 7px', borderRadius: 4, fontFamily: 'var(--font-ui)' },
  orcidBlock: { textAlign: 'center', padding: '0 20px' },
  orcidLabel: { fontSize: 17, fontWeight: 700, color: 'oklch(0.6 0.01 80)', letterSpacing: '0.08em', textTransform: 'uppercase', fontFamily: 'var(--font-ui)', marginBottom: 3 },
  orcidId: { fontSize: 17, fontFamily: 'var(--font-mono)', color: 'oklch(0.3 0.01 80)', marginBottom: 4 },
  ...
  statsBlock: { display: 'flex', gap: 20, borderLeft: '1px solid oklch(0.92 0.008 80)', paddingLeft: 20 },
  statItem: { textAlign: 'center' },
  statBig: { fontSize: 30, fontWeight: 700, color: 'oklch(0.13 0.015 80)', fontFamily: 'var(--font-display)', letterSpacing: '-0.02em' },
  statSmall: { fontSize: 16, color: 'oklch(0.6 0.01 80)', fontFamily: 'var(--font-ui)' },
  tabBar: { display: 'flex', borderBottom: '1px solid oklch(0.92 0.008 80)', padding: '0 32px', background: '#fff' },
  tab: { background: 'none', border: 'none', borderBottom: '2px solid transparent', padding: '9px 12px 11px', fontSize: 16, color: 'oklch(0.55 0.01 80)', cursor: 'pointer', fontFamily: 'var(--font-ui)', transition: 'all 0.15s' },
  ...
  card: { background: '#fff', borderRadius: 12, border: '1px solid oklch(0.91 0.008 80)', padding: '18px 20px' },
  cardTitle: { fontSize: 16, fontWeight: 700, color: 'oklch(0.2 0.01 80)', marginBottom: 12, fontFamily: 'var(--font-ui)', display: 'flex', alignItems: 'center', gap: 14 },
  ...
  activityRow: { display: 'flex', alignItems: 'flex-start', gap: 14, padding: '6px 0', borderBottom: '1px solid oklch(0.96 0.004 80)' },
  activityDot: { width: 7, height: 7, borderRadius: '50%', marginTop: 3, flexShrink: 0 },
  activityLabel: { fontSize: 17.5, color: 'oklch(0.25 0.01 80)', fontFamily: 'var(--font-ui)', lineHeight: 1.4 },
  activityTime: { fontSize: 16, color: 'oklch(0.65 0.01 80)', fontFamily: 'var(--font-ui)', marginTop: 1 },
  creditRow: { display: 'flex', alignItems: 'center', gap: 14, marginBottom: 7 },
  creditLabel: { fontSize: 17, color: 'oklch(0.4 0.01 80)', fontFamily: 'var(--font-ui)', width: 130, flexShrink: 0 },
  barTrack: { flex: 1, height: 5, background: 'oklch(0.93 0.01 80)', borderRadius: 3, overflow: 'hidden' },
  barFill: { height: '100%', background: 'oklch(0.42 0.14 260)', borderRadius: 3, transition: 'width 0.5s ease' },
  creditPct: { fontSize: 17, color: 'oklch(0.55 0.01 80)', fontFamily: 'var(--font-mono)', width: 30, textAlign: 'right' },
  reputationNote: { fontSize: 17, color: 'oklch(0.55 0.01 80)', fontFamily: 'var(--font-ui)', lineHeight: 1.5, marginBottom: 12 },
  tableWrap: { background: '#fff', borderRadius: 12, border: '1px solid oklch(0.91 0.008 80)', padding: '18px 22px' },
  pubRow: { display: 'flex', alignItems: 'center', gap: 14, padding: '12px 0', borderBottom: '1px solid oklch(0.95 0.004 80)' },
  ...
  pubTitle: { fontSize: 17, fontWeight: 500, color: 'oklch(0.2 0.01 80)', fontFamily: 'var(--font-ui)', marginBottom: 2 },
  pubMeta: { fontSize: 17, color: 'oklch(0.6 0.01 80)', fontFamily: 'var(--font-ui)' },
  licTag: { fontSize: 16, padding: '2px 6px', borderRadius: 4, fontWeight: 600, fontFamily: 'var(--font-ui)' },
  copyrightNote: { fontSize: 16, color: 'oklch(0.65 0.01 80)', fontFamily: 'var(--font-ui)' },
  reviewHeader: { display: 'flex', gap: 16, marginBottom: 16, paddingBottom: 16, borderBottom: '1px solid oklch(0.94 0.004 80)' },
  reviewStat: { flex: 1, textAlign: 'center', background: 'oklch(0.97 0.008 80)', borderRadius: 12, padding: '10px' },
  reviewStatNum: { fontSize: 30, fontWeight: 700, color: 'oklch(0.2 0.01 80)', fontFamily: 'var(--font-display)' },
  reviewStatLabel: { fontSize: 16, color: 'oklch(0.6 0.01 80)', fontFamily: 'var(--font-ui)', marginTop: 2 },
  reviewRow: { display: 'flex', alignItems: 'center', gap: 14, padding: '10px 0', borderBottom: '1px solid oklch(0.96 0.004 80)' },
  qualityDot: { width: 8, height: 8, borderRadius: '50%', flexShrink: 0 },
  reviewNote: { fontSize: 17, color: 'oklch(0.6 0.01 80)', fontFamily: 'var(--font-ui)', marginTop: 14, lineHeight: 1.6, fontStyle: 'italic' },
};
